...
test('inicia con propuestas reales y copy multicanal', async () => {
  ...
  assert.ok(publications.every(item => item.copies.instagram.includes('Situación hipotética basada en patrones operativos comunes.')));
  assert.ok(publications.every(item => item.copies.instagram.includes('#')));
